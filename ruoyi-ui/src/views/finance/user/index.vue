    ...
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="角色" prop="role">
        <el-select v-model="queryParams.role" placeholder="请选择角色" clearable>
          <el-option
            v-for="dict in dict.type.fin_user_role"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['finance:user:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['finance:user:export']"
        >导出</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          v-hasPermi="['finance:user:resetPwd']"
        >重置密码</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="角色" align="center" prop="role">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.fin_user_role" :value="scope.row.role"/>
        </template>
      </el-table-column>
    ...
    <el-dialog title="重置密码" :visible.sync="resetOpen" width="400px" append-to-body>
      <el-form ref="pwdForm" :model="pwdForm" :rules="pwdRules" label-width="80px">
        ...
        <el-form-item label="确认密码" prop="confirmPassword">
          <el-input v-model="pwdForm.confirmPassword" placeholder="请再次输入新密码" type="password" />
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
...
<script>
import { listUser, getUser, delUser, addUser, updateUser, resetUserPwd } from "@/api/finance/user";

export default {
  name: "User",
  dicts: ['fin_user_role', 'sys_normal_disable'],
  data() {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('finance/user/export', {
        ...this.queryParams
