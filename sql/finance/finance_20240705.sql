...
values (1, 'admin', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', 'admin123', '管理员', '系统管理员',
        'admin@example.com', '13800138000', 'admin', null, 0, null, null, null, '0', 'admin', sysdate(), '', null,
        sysdate(), '系统管理员');
insert into fin_users
values (2, 'test', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', 'admin123', '测试用户', '测试用户',
        'test@example.com', '13900139000', 'user', null, 0, null, null, null, '0', 'admin', sysdate(), '', null,
        sysdate(), '测试用户');
...
(
  ...
  auto_increment = 100 comment = '登录历史表';
...
(
  ...
  auto_increment = 100 comment = '分类表';
...
insert into fin_categories
values (4, '住房', 1, 'house', '#9C27B0', null, 4, '0', 'admin', sysdate(), '', null, '房租、水电、物业、宽带等');
insert into fin_categories
values (5, '娱乐', 1, 'entertainment', '#FFC107', null, 5, '0', 'admin', sysdate(), '', null, '电影、游戏、KTV、旅游等');
-- 收入分类
insert into fin_categories
values (6, '工资', 2, 'salary', '#3F51B5', null, 1, '0', 'admin', sysdate(), '', null, '工资收入');
insert into fin_categories
values (7, '奖金', 2, 'bonus', '#E91E63', null, 2, '0', 'admin', sysdate(), '', null, '奖金收入');
insert into fin_categories
values (8, '理财', 2, 'finance', '#009688', null, 3, '0', 'admin', sysdate(), '', null, '理财收入');
...
(
  ...
  auto_increment = 100 comment = '交易记录表';
...
(
    ...
    usedAmount        decimal(12, 2) not null comment '已使用金额',
    warning_threshold decimal(5, 2)  not null default '80.00' comment '预警阈值（百分比）',
    usedPercentage    decimal(5, 2)  not null default '0' comment '已使用百分比',
    warned            tinyint(1)     not null default '0' comment '是否已预警',
    notifyEnable      tinyint(1)     not null default '0' comment '是否启动预警提醒',
    del_flag          char(1)                 default '0' comment '删除标志（0代表存在 2代表删除）',
    create_by         varchar(64)             default '' comment '创建者',
    create_time       datetime comment '创建时间',
    update_by         varchar(64)             default '' comment '更新者',
  ...
  auto_increment = 100 comment = '预算表';
...
(
  ...
  auto_increment = 100 comment = '分类规则表';
...
insert into fin_category_rules
values (3, 3, '公交|地铁|打车|出租|滴滴|高铁|火车|机票', null, '0', 'admin', sysdate(), '', null, '交通分类匹配规则');
insert into fin_category_rules
values (4, 4, '房租|水电|物业|宽带|煤气|有线', null, '0', 'admin', sysdate(), '', null, '住房分类匹配规则');
insert into fin_category_rules
values (5, 5, '电影|游戏|KTV|演唱会|旅游|景点', null, '0', 'admin', sysdate(), '', null, '娱乐分类匹配规则');
